import { Item, ItemPool, ItemQualities } from "./Isaac";
export const ItemPoolData: ItemPool[] = [
  {
    "name": "treasure",
    "items": [
      {
  ...
  export const ItemMetaData: ItemQualities = new Map([
    [
      1,
      3
    ],
  ...
  export const ItemData: Map<number, Item> = new Map([
    [
      1,
      {
        "name": "The Sad Onion",
    ...
    [
      120,
      {
        "name": "Odd Mushroom",
        "id": 120,
        "description": "Tears up + damage down",
        "type": "passive"
      }
    ],
    [
